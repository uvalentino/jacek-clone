...
const myFunc = (navCondition) => {
    if (navCondition === 'open'){
        ...
        btnBars.style.dispaly = 'none';
    } 
    else if (navCondition === 'close') {
            SideNav.classList.remove('show-nav');
            btnTimes.style.display = 'none';
            btnBars.style.dispaly = 'block';
    }
}
...
$(document).ready(function (){
    if(!$("#myCanvas").tagcanvas({
        ...
        // something went wrong hide canvas container,
        $("#myCanvasContainer")
    }
})
...
const Validate = () =>{
    ...
    if(!email && !textarea){
        ...
        emailjs.sendForm(serviceID, "template_d32ix5s", templateParams, "ID25U1N6WN3XbKSFV")
